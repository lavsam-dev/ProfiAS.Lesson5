package lavsam.gb.profiaslesson5.utils.ui
...
private const val NO_ROOT_YET = "Cannot get View, there is no root yet"
private const val VIEW_WITH_ID = "View with id "
private const val NOT_FOUND_ROOT = " not found in root"
    ...
    operator fun getValue(thisRef: Any?, property: KProperty<*>): T {
        ...
        if (currentRoot != cachedRoot || view == null) {
            if (currentRoot == null) {
                ...
                throw IllegalStateException(NO_ROOT_YET)
            }
        ...
        checkNotNull(view) { VIEW_WITH_ID + viewId + NOT_FOUND_ROOT }
        return view
    }
}
